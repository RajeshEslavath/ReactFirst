    ...
    <div className='container mx-auto p-4 text-center bg-gradient-to-r from-green-200 to-green-500'>
        <div className='min-h-screen flex flex-col justify-center'>
            ...
            {questions.length>0?(
                showScore?(
                    <div>
                        <h2 className='text-xl font-sembold mb-4'>
                    ...
                    <div className='bg-slate-100 mx-52 rounded-md p-5'>
                        ...
                        <div className='grid grid-cols-2 gap-4 mx-44'>
                            ...
                            <button className='bg-blue-500 text-white py-2 px-4 rounded-md hover:bg-blue-600' onClick={()=>handleClick(questions[currentQuestion].correct_answers)}>
